...
- Test: `npm run test` (currently a placeholder script until automated suite is added)
- Build: `npm run build`

All checks must pass before merge. Keep PRs small and focused.

## Previews & Production
- Platform: Vercel (Node.js 22 LTS)
...
- Ensure Node.js version is 22 LTS via package `engines` or Vercel Project Settings.
