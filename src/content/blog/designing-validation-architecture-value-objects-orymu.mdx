...
On real screens this pattern grew much bigger, with many more fields and rules:

- Dozens of inputs and UI flags.
...
It worked, but everything still lived in a single controller class.
